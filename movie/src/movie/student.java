...
public class student {
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(160, 39, 121, 22);
		frame.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("ID");
		lblNewLabel_1.setForeground(new Color(255, 0, 128));
		lblNewLabel_1.setFont(new Font("Sitka Text", Font.BOLD | Font.ITALIC, 12));
		...
		lblNewLabel_2.setBounds(90, 100, 46, 20);
		...
		lblNewLabel_3.setBounds(90, 131, 56, 14);
		frame.getContentPane().add(lblNewLabel_3);
		
		tb1 = new JTextField();
		tb1.setBounds(178, 72, 86, 20);
		frame.getContentPane().add(tb1);
		tb1.setColumns(10);
		
		tb2 = new JTextField();
		tb2.setBounds(178, 98, 86, 20);
		frame.getContentPane().add(tb2);
		tb2.setColumns(10);
		
		JComboBox cb1 = new JComboBox();
		cb1.setModel(new DefaultComboBoxModel(new String[] {"SELECT", "cse", "aiml", "It", "Iot"}));
		cb1.setBounds(178, 127, 86, 22);
		...
		lblNewLabel_4.setBounds(90, 163, 46, 14);
		frame.getContentPane().add(lblNewLabel_4);
		
		tb3 = new JTextField();
		tb3.setBounds(178, 160, 86, 20);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
				 java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://loaclhost:3306/mydb","root","mrec");
